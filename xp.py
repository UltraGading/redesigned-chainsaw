...
print("{}% of data for math score lies between first standard deviation".format(len(m_data_within_first_sd)*100/len(m_list)))
print("{}% of data for math score lies between second standard deviation".format(len(m_data_within_second_sd)*100/len(m_list)))
print("{}% of data for math score lies between third standard deviation".format(len(m_data_within_third_sd)*100/len(m_list)))
...
print("{}% of data for reading score lies between first standard deviation".format(len(r_data_within_first_sd)*100/len(r_list)))
print("{}% of data for reading score lies between second standard deviation".format(len(r_data_within_second_sd)*100/len(r_list)))
print("{}% of data for reading score lies between third standard deviation".format(len(r_data_within_third_sd)*100/len(r_list)))
...
print("{}% of data for writing score lies between first standard deviation".format(len(w_data_within_first_sd)*100/len(w_list)))
print("{}% of data for writing score lies between second standard deviation".format(len(w_data_within_second_sd)*100/len(w_list)))
print("{}% of data for writing score lies between third standard deviation".format(len(w_data_within_third_sd)*100/len(w_list)))